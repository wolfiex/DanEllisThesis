...
Often we are faced with the problem of determining the source of a species production. To do this, we select a case study of \ch{NC101CO} from the Borneo simulation run from the MCM. In tracing back the precursors of this (see below), it is seen that \ch{NC101CO} is the product of $\alpha$-pinene forming NAPINBOOH, NAPINBO, \ch{NAPINBO2} and consequently \ch{NC101CO}. This can also be seen in the subgraph in \autoref{fig:prtest1} - observing the outwards arrows only (these point in the direction of the source node).
...
\caption{\textbf{The reversed subgraph between $\alpha$-pinene, and \ce{NC101CO}.}\\ This is a subgraph showing the production of \ce{NC101CO}. Arrows point towards a species precursor. }
\label{fig:prtest1}
\end{figure}
