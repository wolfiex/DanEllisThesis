...
It is possible to see that several groups form arcs highlighting the cyclic \ce{OH -> HO2} chemistry,
\autoref{fig:rxnho2oh}. It is also visible that there are a significant number of OH reactions, which corresponds to our knowledge of the mechanism,
