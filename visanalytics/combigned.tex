...
\subsubsection*{Edge Crossing} \label{edgecross}
...
\subsubsection*{Node Distribution and Overlap}
...
In addition to the selection of a layout with a better distribution of nodes, there are several methods in which overlapping nodes may be removed. Although many algorithms aim to reduce this, the treatment of nodes as `point masses' make it difficult to account for overlapping points \citep{nodeoverlap}. In general there are two methods in which overlapping nodes may be reduced \citep{IPSEPCOLA}:
...
\begin{figure}[H]
     \centering
     \includegraphics[width=0.25\textwidth, angle=90]{figures_c1/layout/memory.png}
